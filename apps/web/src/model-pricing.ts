...
export const modelPricing: Record<string, ModelPricing> = {
  ...
  "gemini-3-pro-preview": { input: "¥13.71 / ¥27.42", output: "¥82.27 / ¥123.41", unit: "1M tokens", source: "Gemini API Pricing", url: "https://ai.google.dev/gemini-api/docs/pricing", note: "参考 Gemini 3.1 Pro Preview <=200K/>200K · 按 USD/CNY 6.8562 换算" },
