...
| Azure OpenAI / Microsoft Foundry | Chat Completions | `POST /openai/v1/chat/completions` | `api-key` or `Authorization` | `model`, `messages` | `stream: true` returns OpenAI-compatible SSE chunks | [Azure OpenAI API v1](https://learn.microsoft.com/azure/ai-foundry/openai/latest) | Uses Azure v1-style path with OpenAI-compatible response format. |
| Azure OpenAI / Microsoft Foundry | Responses | `POST /openai/v1/responses` | `api-key` or `Authorization` | `model`, `input` | `stream: true` returns Responses-style SSE events | [Azure OpenAI API v1](https://learn.microsoft.com/azure/ai-foundry/openai/latest) | Uses Azure v1-style path with OpenAI Responses-compatible response format. |
